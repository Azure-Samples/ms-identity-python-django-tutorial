...
1. In the **Register an application page** that appears, enter your application's registration information:
   - In the **Name** section, enter a meaningful application name that will be displayed to users of the app, for example `b2c-python-django-webapp-auth`.
...
1. Find the key `client.client_id` and replace the existing value with the application ID (clientId) of the `b2c-python-django-webapp-auth` application copied from the Azure portal.
1. Find the key `client.client_credential` and replace the existing value with the client secret you saved during the creation of the `b2c-python-django-webapp-auth` app, in the Azure portal.
